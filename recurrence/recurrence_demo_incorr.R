...
incorrect = list(21, 105, 135, 194, 207, 297, 301, 327, 439, 452, 476)
...
rec_analysis = crqa(ts1 = rescaled_dist_x, 
                    ...
                    r = 0.5, # you can keep playing with this to find something that works
                    normalize = 0, 
...
legend(1, 901, legend=c("Every trial"),
